...
import sympy
st.write("SymPy loaded:", sympy.__version__)
...
# ========================
    ...
    if st.button("Compute"):
        ...
        if Fx_e and Fy_e and Fz_e:
            ...
            st.write("### Cell-wise Results")
            st.write("Divergence ∇·F:", divergence)
            st.write("Curl ∇×F:", curl)